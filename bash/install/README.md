...
```bash
curl -L https://raw.githubusercontent.com/crowdstrike/falcon-scripts/v1.5.3/bash/install/falcon-linux-uninstall.sh | bash
```
...
```bash
curl -L https://raw.githubusercontent.com/crowdstrike/falcon-scripts/v1.5.3/bash/install/falcon-linux-install.sh | bash -x
```
