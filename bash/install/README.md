...
```bash
curl -L https://raw.githubusercontent.com/crowdstrike/falcon-scripts/v1.3.0/bash/install/falcon-linux-install.sh | bash
```
...
```bash
curl -L https://raw.githubusercontent.com/crowdstrike/falcon-scripts/v1.3.0/bash/install/falcon-linux-install.sh | bash -x
```
