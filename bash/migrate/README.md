...
curl -L https://raw.githubusercontent.com/crowdstrike/falcon-scripts/v1.12.1/bash/migrate/falcon-linux-migrate.sh | sudo bash
```
...
```bash
curl -L https://raw.githubusercontent.com/crowdstrike/falcon-scripts/v1.12.1/bash/migrate/falcon-linux-migrate.sh | bash -x
```
